...
def main():
    sys.argv = ['test_t5.py',
            ...
            '--model_name_or_path',
            'output/t5-large_lora_minus_cnndm_once_global_free_inout_nodistill/mac0.4/epoch5/bz16/numprune5/parameq:0-23,ev:0-23,dq:0-23,dv:0-23,cq:0-23,cv:0-23,ei:0-23,di:0-23/lora_r8/lora_alpha16/best_model',
            '--task_name',
            'cnndm',
            '--do_train',
            '--do_eval',
