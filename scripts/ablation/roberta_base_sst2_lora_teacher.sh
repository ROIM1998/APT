...
pruning_start=-1
pruning_stop=3
distill_start=0 # about 60%, between 3.4 and 3.8, but after 3.6 where the teacher is updated
distill_epoch=20
pruning_batches=64
num_prunings=10
...
teacher_path='output/roberta-base/sst2/bz32/lora/epoch60/lora_r8/lora_alpha16/lr2e-4/seed42/best_model'
