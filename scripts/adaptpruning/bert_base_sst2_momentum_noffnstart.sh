...
pruning_start=-1
pruning_stop=6
distill_start=3.4 # about 60%, between 1.4 and 1.8, but after 1.6 where the teacher is updated
distill_epoch=10
pruning_batches=64
num_prunings=10
pruning_batch_size=4
pre_pruning_tuning_epochs=2
...
suffix=_noffnstart_largertune_longerprune
